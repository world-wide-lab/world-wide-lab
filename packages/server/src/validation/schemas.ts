...
const fullResponseSchema = object({
  ...
  // Unlike responseId, this id is generated by the client and therefore part
  // of the request when creating a response.
  clientResponseId: number().integer().min(0).optional(),
}).noUnknown();
