...
function defineModels(sequelize: Sequelize) {
  ...
  const Response = sequelize.define(
    ...
    },
    {
      ...
      indexes: [
        {
          // Responses are de-duplicated via this index, so that clients can
          // safely re-send responses they did not get a confirmation for.
          name: "idx_wwl_responses_sessionId_clientResponseId",
          unique: true,
          fields: ["sessionId", "clientResponseId"],
        },
      ],
    },
  );
